...
<title>SWOS 96/97 - Editor hráčů a kariér</title>
<style>
  :root {
    --bg-main: #0a1118;
    --bg-card: #121e2b;
...
<div class="top-nav">
  ...
  <div style="display: flex; align-items: center; gap: 14px;">
    <div class="lang-toggle">
      ...
      <button class="lang-btn active" id="lang-btn-cs" onclick="setLanguage('cs')">🇨🇿 CZ</button>
    </div>
    <span id="player-count" style="font-size:0.85rem; color:var(--text-muted);">0 hráčů</span>
...
let currentLang = localStorage.getItem('swos_lang') || 'cs';
